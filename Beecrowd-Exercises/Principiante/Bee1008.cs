namespace Beecrowd_Exercises.Principiante
{
    public class Bee1008
    {
       ...
       el mes y el monto recibido por hora. Imprimir el número de empleado y el salario que 
       él/ella recibirá a fin de mes, con dos lugares decimales.
       ...
       representando el número, cantidad de horas trabajadas y el monto recibido del empleado
       por hora trabajada.
